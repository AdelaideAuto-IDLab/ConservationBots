function [config] = simulation_config_wrapper_2018(ntarget, reward, Use_Void, rotation_time, pd, scenario)
	...
	case 'Scenario5_kangaroo_test.mat'
    	imprecision_range = repmat([-16; 10], 1, ntarget);  
    	DEM_file = 'Kangaroo_test_DEM';
